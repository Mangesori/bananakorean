const popup = () => {
  ...
  gallaryContainers.forEach(function (gallaryContainer) {
    ...
    const sliderContainer = gallaryContainer.querySelector('.slider-container-wrapper');
    ...
    function showImage(index) {
      ...
      const slideCounter = `<span class="slide-counter">${index + 1} of ${images.length}</span>`;
