    ...
    <main className="bg-bodyBg max-w-4xl mx-auto md:max-w-3xl lg:max-w-4xl px-4 md:px-8 py-6 md:py-10 rounded-xl h-[85vh] overflow-y-auto relative">
      <div className="wrapper bg-gray-150 -mt-6 absolute left-0 right-0 mx-0 rounded-xl p-4 md:p-8 pb-32">
        ...
        <div className="question-wrapper -mt-4 flex flex-wrap w-full gap-3 text-lg">
          {/* 질문 부분 */}
          <div
            className="flex w-full items-center gap-2 mt-10 relative cursor-pointer"
            onClick={() => setShowQuestionHint(!showQuestionHint)}
          >
            <div className="text-2xl font-extrabold text-primaryColor w-8">Q:</div>
            <div className="text-2xl font-medium relative">
              {showQuestionHint && (
                <div className="absolute bottom-full left-0 mb-2 bg-white border-2 border-yellow-400 rounded p-2 z-10 text-base whitespace-nowrap">
          ...
          {/* 답변 부분 */}
          <div
            className="flex w-full items-center gap-2 mt-4 relative cursor-pointer"
            onClick={() => setShowAnswerHint(!showAnswerHint)}
          >
            <div className="text-2xl font-extrabold text-primaryColor w-8">A:</div>
            <div className="text-2xl font-medium border-b-2 border-solid border-black min-h-[36px] min-w-[250px] w-[30%] mb-2 relative">
              {showAnswerHint && (
                <div className="absolute inset-0 bg-white/90 border-2 border-yellow-400 rounded p-2 z-10 flex items-center text-base">
                  ...
                  <div className="mt-2">
                    ...
                    {showAnswerHint && (
                      <div className="mt-3 p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
                        ...
                        <div className="text-lg">{currentQuestion.answer}</div>
                      </div>
                    )}
                  </div>
                </div>
